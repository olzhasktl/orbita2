...
config = {}
cmdline = ['C:/Marmalade/7.5/s3e/makefile_builder/mkb.py', 'c:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/Stage4.mkb', '--deploy-only', '--hub-data', 'C:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/project_Stage4/mkb-wp81.txt', '--buildenv=VC12', '--buildenv-toolset=WP81']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'wp81-arm' : {
                   'debug'   : r'c:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/build_stage4_vc12_wp81toolset/Debug_Stage4_VC12_WP81TOOLSET_arm/Stage4.s86',
                   'release' : r'c:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/build_stage4_vc12_wp81toolset/Release_Stage4_VC12_WP81TOOLSET_arm/Stage4.s86',
                 },
         'wp81-x86' : {
                   'debug'   : r'c:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/build_stage4_vc12_wp81toolset/Debug_Stage4_VC12_WP81TOOLSET_x86/Stage4.s86',
                   'release' : r'c:/Marmalade/7.5/examples/GameTutorial/CPP/Stage4/build_stage4_vc12_wp81toolset/Release_Stage4_VC12_WP81TOOLSET_x86/Stage4.s86',
                 },
        }
    arm_arch = ''
